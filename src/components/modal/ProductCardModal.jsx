...
export default function ProductCardModal({ isOpen, onClose, product }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div 
        className="relative bg-white w-full max-w-5xl max-h-[92vh] overflow-hidden rounded-2xl shadow-2xl flex flex-col md:flex-row animate-in fade-in duration-300"
