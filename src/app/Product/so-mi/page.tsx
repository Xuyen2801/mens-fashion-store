...
import content from "../../../data/Product/So-mi/contentSeeMoreSomi";
import faqaothun from "../../../data/Product/So-mi/soMiFAQ";
    ...
    <div className="min-h-screen flex flex-col font-sans bg-gray-50 ">
      <main className="flex-grow">
        ...
        <div className="w-full overflow-hidden shadow-lg">
          <CollectionBanner backgroundImage="/images/banners/2000x900_-_banner_nhom_sp_-_ao_somi.jpg" />
        </div>
