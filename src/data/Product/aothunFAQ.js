const aothunFAQ =[
  ...
  },
  {
    ...
    "content": "Bạn chỉ cần cung cấp chiều cao, cân nặng và kiểu mặc yêu thích (ôm vừa hay rộng), đội ngũ tư vấn sẽ gợi ý size phù hợp. Bạn cũng có thể so với chiếc áo thun đang mặc vừa ở nhà và đối chiếu bảng size trên trang sản phẩm để tự tin hơn."
  },
  {
